...
def usage():
    print "\033[1;32m#########################################################"
    print "#------------------------[\033[1;91mTEAM-DDOS\033[1;32m]---------------------#"
    print "#-------------------------------------------------------#"
    print "#   \033[1;91mวิธีใช้งานพิมคำสั่งตามนี้: " "python2 TEAMDDOS.py " "<ipที่จะยิง> <ตามด้วยport ตัวอย่าง 80> <ตามด้วยpacket 1-100 ต่อครั้ง> \033[1;32m   #"
    print "#                                                       #"
